...
def parse_args():
    ...
    parser.add_argument("--model_save_path", type=str, default="./adapter_final.pt",
...
def main():
    ...
    print(f"Число параметров адаптера: {sum(p.numel() for p in adapter.parameters())}")

    optimizer = AdamW(adapter.parameters(), lr=args.learning_rate)
    ...
    for epoch in range(args.epochs):
        ...
        torch.save({
            ...
            'loss': loss_value,
        }, f'checkpoint_{args.adapter_type}_epoch_{epoch}.pt')
